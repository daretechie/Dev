...
words = {'Colors': 'red orange yellow green blue indigo violet white black brown'.split(),
         ...
         'Animals': 'ant baboon badger bat bear beaver camel cat clam cobra cougar coyote crow deer dog donkey duck '
                    'eagle elephant eel ferret fish fox frog goat goose hawk leech lion lizard llama mole monkey '
                    'moose mouse mule newt otter owl panda parrot pigeon python rabbit ram rat raven rhino salmon '
                    'seal shark sheep skunk squid sloth snake spider stork swan tiger toad trout turkey turtle weasel '
